...
import com.husnasari.emporium_backend.exception.SellerException;
...
public class SellerController {
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws Exception, MessagingException {
        ...
        String subject = "Emporium Email Onay Kodu";
        String text = "Emporium'a Hoşgeldiniz, bu bağlantıyı kullanarak hesabınızı doğrulayın:";
